...
import { HeaderTag } from "../Land-pages/helper";
    ...
    <div>
      {modal && (
        <div className="modal-overlay">
          <div className="otp-Form">
            ...
            <span className={`errorMsg ${otpError ? "seterror1" : ""} `}>
              Enter all fields
            </span>
            <div className="exitBtn" onClick={() => setModal(false)}>
              ×
            </div>
      ...
      <div className="back-img1">
        ...
        <HeaderTag
          ...
          desc="Regain access to your account by following the password recovery process and secure your digital presence."
        />
      </div>
      ...
      <span className={`errorMsg ${error ? "seterror" : ""} `}>
        Please enter a phone number correctly (more than 6 numbers)
      </span>
      <div className="btn-forget-tags">
        <button onClick={onNextClick}>Send Code</button>
      </div>
    </div>
  );
};
